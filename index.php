                    ...
                    <div class="col col-xs-12">
                        <div class="features-grids">
                            <div class="grid">
                                ...
                                <p>When Gregor Samsa woke from troubled dreams, he found himself transformed in his
                                    dereman bed.</p>
                            </div>
                            <div class="grid">
                                <div class="icon">
                                ...
                                <h3>Market Reacherch</h3>
                                <p>Dismicon dninga Samsa woke from troubled dreams, he found himself transformed in his
                                    bed.</p>
                            </div>
                            <div class="grid">
                                <div class="icon">
                ...
                <div class="row">
                    <div class="col col-lg-6">
                        <div class="services-list-wrapper">
                            <div class="clearfix">
                                <ul>
                                    <li><a href="#"><i class="flaticon-check"></i> Electrical, Control and
                                            Instrumentation Services</a></li>
                                    <li><a href="#"><i class="flaticon-check"></i> Asbestos Remediation</a></li>
                                    <li><a href="#"><i class="flaticon-check"></i> industrial Cleaning Services</a></li>
                                    <li><a href="#"><i class="flaticon-check"></i> Agriculture Processing</a></li>
                                    <li><a href="#"><i class="flaticon-check"></i> Oil & Lubricant</a></li>
                                </ul>
                                <ul>
                                    <li><a href="#"><i class="flaticon-check"></i> Commercial waste solutions</a></li>
                                    <li><a href="#"><i class="flaticon-check"></i> SafeZone Positive Pressure
                                            Habitats</a></li>
                                    <li><a href="#"><i class="flaticon-check"></i> Energy & Power Engineering</a></li>
                                    <li><a href="#"><i class="flaticon-check"></i> Oil & Gas Engineering</a></li>
                                    <li><a href="#"><i class="flaticon-check"></i> Energy & Power Engineering</a></li>
                                </ul>
                            </div>
                            <p>N:B: ower arm towards the viewer. Gregor then turned to look out the window at the dull
                                weather. Drops</p>
                        </div>
                    </div>
                    <div class="col col-lg-6">
                        <div class="video-holder">
                            <div class="img-holder">
                                <img src="assets/images/service-video-bg.jpg" alt>
                            </div>
                        ...
                        <div class="about-features clearfix">
                            <div class="grid">
                                ...
                                <div class="details">
                                    ...
                                    <p>Lay peacefully between its four familiar walls. A collection of textile samples
                                        lay spread out on the table.</p>
                                </div>
                            </div>
                            <div class="grid">
                                <div class="icon">
                            ...
                            <div class="grid">
                                <div class="quote">
                                    <p>It wasn't a dream. His room, a proper human room although a little too small, lay
                                        ...
                                        spread out on the table Samsa was a travelling salesman.A collection of textile
                                        samples lay spread out on the table Samsa was a travelling salesman.</p>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-lg-7 col-sm-8">
                        <div class="cta-text">
                            <h2>Providing industrial services we have earned <span>a lot Good well</span> over the year
                            </h2>
                    ...
                    <div class="col col-lg-3 col-lg-offset-2 col-sm-4">
                        <div class="contact-info">
                            <h4>25556-4657-54</h4>
                            <a href="#" class="theme-btn">Contact with us</a>
                        </div>
                    </div>
                </div>
            </div> <!-- end container -->
        ...
        <section class="contact-section">
            ...
            <div class="content-area">
                ...
                <div class="right-col">
                    <div class="contact-info">
                        <ul>
                            <li><i class="ti-mobile"></i> <span>Phone:</span> 36456841657498416</li>
                            <li><i class="ti-email"></i> <span>Email:</span> example@demo.com</li>
                            <li><i class="ti-microphone"></i> <span>FAX:</span> 6565462651647</li>
                            <li><i class="ti-location-pin"></i> <span>Address:</span> 41 no hours bull grame gramble
                                united</li>
                            <li><i class="ti-alarm-clock"></i> <span>Address:</span> WORKING HOURS: 09.00AM - 05.00 PM
                            </li>
                        </ul>
                    </div>
                </div>
