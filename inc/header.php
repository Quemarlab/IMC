                    ...
                    <div class="row">
                        <div class="col col-md-10 col-sm-9">
                            <div class="contact-info">
                                <ul>
                                    <li><i class="ti-mobile"></i> Kigali, RWANDA EA Community</li>
                                    <li><i class="ti-email"></i> info@smc.com</li>
                                </ul>
                            </div>
                        </div>
            ...
            <nav class="navigation navbar navbar-default">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><img src="ControlPanel/assets/logo/logo.png" alt style="width: 35%; height: 35%; "></a>
                    </div>
